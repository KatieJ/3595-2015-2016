    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (startPos == 0) { // Near
            if (whichAuto == 0) { // Near full
                ...
                if (color == 0) // If red
                    turnCounterClockwise(1.0, 50, 3.0);
                else // If blue
                ...
                // Drive to shelter
                gyroCorrection(-1.0, 8000, 7.5, true);
                ...
                gyroCorrection(-1.0, 500, 2.0, false);
            ...
            if(whichAuto == 0) { // Far full
                ...
                // Turn towards shelter
                if(color == 0) // if red
                    turnCounterClockwise(0.75, 58, 3.0);
                else // if blue
                ...
                // Drive to shelter
                gyroCorrection(-1.0, 13000, 7.5, true);
                ...
                if(color == 0) // If red
                    turnCounterClockwise(1.0, 77, 3.0);
                else // If blue
                    turnClockwise(1.0, 77, 3.0);

                // Drive onto mountain
                gyroCorrection(-1.0, 6000, 8.0, true);
                leftFenderServo.setPosition(leftFenderUp);
                rightFenderServo.setPosition(rightFenderUp);
                gyroCorrection(-1.0, 1500, 2.0, false);
        ...
        if(whichAuto == 0 && endPos != 2) { // if running full autonomous and moving after scoring
            leftBrushMotor.setPower(-1.0);
            rightBrushMotor.setPower(-1.0);
            gyroCorrection(-1.0, 6000, 4.0, true);
            leftBrushMotor.setPower(0.0);
            rightBrushMotor.setPower(0.0);
            ...
            if (endPos == 0) {
                while (autoTimer.time() < 26)
                    sleep(50);
                gyroCorrection(0.5, 4000, 4.0, true);
            }
        }
    }
