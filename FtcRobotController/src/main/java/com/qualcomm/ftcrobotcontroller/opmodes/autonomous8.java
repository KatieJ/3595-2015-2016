...
public class autonomous8 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        calibrateGyro(); // move this before waitForStart() and reset z axis integrator (ALSO X AXIS) or what it is here
            ...
            throws InterruptedException
    {
        ...
        while (absoluteValue(leftDrive1.getCurrentPosition()-zeroedEncoders) < clicks && driveTimer.time() < timeout) {
