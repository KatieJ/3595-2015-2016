...
public class batteriesAutoBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        turnClockwise(0.75, 41);

        // Drive to shelter
        gyroCorrection(-0.3, 8000, 5.5);
        ...
        turnCounterClockwise(.65, 85);

        leftBrushMotor.setPower(-1.0);
        rightBrushMotor.setPower(-1.0);
        gyroCorrection(-0.4, 8000, 5.0);
        leftBrushMotor.setPower(0.0);
        rightBrushMotor.setPower(0.0);
/*
