...
// General tele-op program for robot (used at Supers)
...
public class TeleOp6 extends OpMode
{
    ...
    public void loop () // Main tele-op code
    {
        ...
        if (gamepad1.right_stick_y >= 0.5) // Rotate lift up when dpad up pressed
        {
            rightLiftServo.setPosition(rightLiftDown);
            leftLiftServo.setPosition(leftLiftDown);
        }
        else if (gamepad1.right_stick_y <= -0.5) // Rotate lift down when dpad down pressed
        {
            rightLiftServo.setPosition(rightLiftUp);
            leftLiftServo.setPosition(leftLiftUp);
        }
