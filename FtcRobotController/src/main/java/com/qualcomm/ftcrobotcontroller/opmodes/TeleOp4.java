...
// General tele-op program for robot (used at State Championship)
// Allow hanging, control of nine different servos, and debris scoring

public class TeleOp4 extends OpMode
{
    // Declaring motors and servos
    DcMotor leftDrive1, leftDrive2, rightDrive1, rightDrive2, liftMotor1, liftMotor2, brushMotor;
    ...
    double rightZipOut = 0.25;
    double leftZipIn = 0.0;
    double leftZipOut = 0.75;
